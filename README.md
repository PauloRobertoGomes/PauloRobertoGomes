...
**Full Stack Developer** com atuação em aplicações web e mobile, com **React Native** e **Flutter** no mesmo peso.
...
### 👨‍💻 Sobre mim
- 🚀 Desenvolvedor **Full Stack** com forte experiência em produtos digitais end-to-end
- 📱 Experiência equivalente em **React Native** e **Flutter**
...
### 👨‍💻 About me
- 🚀 **Full Stack Developer** building end-to-end web and mobile products
- 📱 Balanced experience with **React Native** and **Flutter**
- 🔭 Currently working at [Co.Urban](https://www.linkedin.com/company/co-urban/posts/?feedView=all)
